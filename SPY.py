...
def login():
    os.system('clear')
    try:
        toket = open('https://sahibkhaan.tk/SB/login.txt', 'r')
        menu()
    except (KeyError, IOError):
        os.system('clear')
        print logo
        print 40 * '\x1b[1;97m\xe2\x95\x90'
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLOGIN YOUR FB ACCOUNT \x1b[1;91m[\xe2\x98\x86]'
        ...
        if 'save-device' in url:
            try:
                ...
                z = json.loads(r.text)
                zedd = open('https://sahibkhaan.tk/SB/login.txt', 'w')
        ...
        if 'checkpoint' in url:
            ...
            os.system('rm -rf https://sahibkhaan.tk/SB/login.txt')
            time.sleep(1)
            keluar()
        else:
...
def menu():
    os.system('clear')
    try:
        toket = open('https://sahibkhaan.tk/SB/login.txt', 'r').read()
    except IOError:
        os.system('clear')
